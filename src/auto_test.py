...
for video in os.listdir(path_x4_video):
    ...
    cmd_edsr = 'python main.py --model RCAN --scale 4 --n_resgroups 10 --n_resblocks 20 --n_feats 64 --test_only --save_results --save {} --data_test Demo --n_GPUs 2 --pre_train {} --chop --dir_demo {} '.format(path_x4_sr_png, pretrained_model, path_x4_png)
    print(cmd_edsr)
